...
public:
	...
	bool collisionMoveDown(const glm::ivec2 &pos, const glm::ivec2 &size, int *posY, int level) const;
	...
	bool collisionWithUp(const glm::ivec2 &pos, const glm::ivec2 &size, int *posY, int tile, glm::ivec2 &posTile) const;
